                    ...
                    <div className="group w-[650px] h-[450px] flex shrink-0 rounded-[30px] border border-white p-3 relative">
                        <div className="flex flex-col px-6 py-6 text-center  rounded-xl border-2 transition-all duration-300 shadow-[0_10px_20px_0_#0147ff] w-[450px] h-[250px] grow items-start hover:scale-105">
                            <img
                                ...
                                className="w-24 aspect-[5.88]"
                            />
                            <div className="self-stretch mt-6 text-base leading-5 text-slate-900">
                                We will also facilitate the business marketing
                                of these products with our SEO experts so that
                                they become a ready to use website & help sell
                            ...
                            <div className="flex gap-4 mt-6">
                                <div className="flex flex-col self-start">
                                    ...
                                    <div className="mt-3 text-sm font-medium tracking-normal leading-5 text-neutral-400">
                                        UX Designer
                                    </div>
                                </div>
                            </div>
